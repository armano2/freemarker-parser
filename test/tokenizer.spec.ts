...
describe('parsing directives', () => {
  it('no arguments', () => {
    ...
    Tester.instance(tokens)
      .hasCount(1)
      .isType(ENodeType.OpenDirective)
      .hasNoParams();
  });
  ...
  it('no arguments, with close tag', () => {
    ...
    Tester.instance(tokens)
      ...
      .hasNoParams()
      .nextToken()
      .isType(ENodeType.CloseDirective)
      .hasNoParams();
  });
  it('with arguments', () => {
...
describe('parsing text', () => {
  it('empty text', () => {
    const tokens = parse('');
    Tester.instance(tokens).hasCount(0);
  });
  it('raw text', () => {
    const tokens = parse('<foo>');
    Tester.instance(tokens)
...
describe('html', () => {
  it('simple', () => {
    ...
    Tester.instance(tokens)
      ...
      .isType(ENodeType.Text)
      .hasNoParams()
      .hasText('<p>This is include-subdir.ftl</p>');
  });
  it('advance', () => {
    const tokens = parse(
